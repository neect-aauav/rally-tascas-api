...
| **[bars](#Fields-team-bars)** | Bars | list<{..., [Bar](#Bars)}> | 🔄 | Team stats on each bar |
...
| ID | Name | Data Type | Default | Description |
|----|------|-----------|:-------:| ----------- |
| **id** | Member ID | integer | 🔄 | Member number identifier |
...
| **[bars](#Fields-member-bars)** | Bars | list<{..., [Bar](#Bars)}> | 🔄 | Member stats on each bar |
...
| **picture** | Picture | string | ␀ | Bar picture |
...
| ID | Name | Data Type | Default | Description |
|----|------|-----------|:-------:| ----------- |
| **id** | Game ID | integer | 🔄 | Game number identifier |
| **name** | Name | string | ✖ | Game name |
| **description** | Description | string | ␀ | Game description |
...
| ID | Name | Data Type | Default | Description |
|----|------|-----------|:-------:| ----------- |
| **id** | Prize ID | integer | 🔄 | Prize number identifier |
...
| **winner** | Winning team | [Team](#teams) | ␀ | Team that won the prize |
